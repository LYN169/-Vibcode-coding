...
**规划展示：** 三维地块、道路与规划定位、用地对比在同一界面呈现，便于结合具体空间讲解方案。

![武功镇规划展示运行画面](../../../docs/showcase/wugong-planning.png)

**现状概况：** 切换到卫星底图与景点导览，同时查看区位、人口、产业和文旅等现状信息。

![武功镇现状与景观资源导览](../../../docs/showcase/wugong-status.png)

以上为 2026-09-12 线上运行截图，保留现有布局与数据；部分标签仍会重叠。[查看完整介绍与演示建议](../../../docs/showcase/README.md)。
